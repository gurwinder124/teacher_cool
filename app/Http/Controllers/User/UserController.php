    ...
    public function index()
    {
        try {
            ...
            $data = DB::table('users')
                    ...
                    ->select('user_details.*','users.name','users.user_type','users.email','users.profile_path','users.teacher_id_number', 'teacher_settings.id_proof','teacher_settings.document_path','teacher_settings.working_hours','teacher_settings.expected_income','teacher_settings.category','teacher_settings.subject_id')
